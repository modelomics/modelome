...
_ARTIFACTS: tuple[tuple[str, str], ...] = (
    ...
    ("size_cytotorch_0.npy", "Cellpose cytoplasm size model"),
    ("size_cyto2torch_0.npy", "Cellpose cyto2 size model"),
    ("size_nucleitorch_0.npy", "Cellpose nuclei size model"),
    ("size_cyto3.npy", "Cellpose cyto3 size model"),
    ("cyto2_cp3", "Cellpose cyto2 Cellpose 3 model"),
    ("tissuenet_cp3", "Cellpose TissueNet Cellpose 3 model"),
    ("livecell_cp3", "Cellpose LiveCell Cellpose 3 model"),
    ("yeast_PhC_cp3", "Cellpose yeast phase-contrast model"),
    ("yeast_BF_cp3", "Cellpose yeast brightfield model"),
    ("bact_phase_cp3", "Cellpose bacterial phase-contrast model"),
    ("bact_fluor_cp3", "Cellpose bacterial fluorescence model"),
    ("deepbacs_cp3", "Cellpose DeepBacs model"),
    ("transformer_cp3", "Cellpose transformer Cellpose 3 model"),
    ("neurips_cellpose_default", "Cellpose NeurIPS U-Net model"),
    ("neurips_cellpose_transformer", "Cellpose NeurIPS transformer model"),
    ("neurips_grayscale_cyto2", "Cellpose NeurIPS grayscale cyto2 model"),
    ("CP", "Cellpose legacy CP model"),
    ("CPx", "Cellpose legacy CPx model"),
    ("TN1", "Cellpose legacy TissueNet model 1"),
    ("TN2", "Cellpose legacy TissueNet model 2"),
    ("TN3", "Cellpose legacy TissueNet model 3"),
    ("LC1", "Cellpose legacy LiveCell model 1"),
    ("LC2", "Cellpose legacy LiveCell model 2"),
    ("LC3", "Cellpose legacy LiveCell model 3"),
    ("LC4", "Cellpose legacy LiveCell model 4"),
    ("tissuenet", "Cellpose legacy TissueNet model"),
    ("livecell", "Cellpose legacy LiveCell model"),
    ("general", "Cellpose legacy general model"),
    ("style_choice.npy", "Cellpose legacy style-choice model data"),
    ("cyto_0", "Cellpose 1 cytoplasm model"),
    ("nuclei_0", "Cellpose 1 nuclei model"),
    ("size_cyto_0.npy", "Cellpose 1 cytoplasm size model"),
    ("size_nuclei_0.npy", "Cellpose 1 nuclei size model"),
