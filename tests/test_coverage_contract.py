...
def test_fixture_model_names_are_not_runtime_seed_constants() -> None:
    ...
    # These occurrences are source identifiers or exact first-party checkpoint
    # descriptions, not fixture seeds.
    source_identifier_literals = {
        "Transformer": {
            ...
            "src/modelome/sources/paddlenlp_funnel_registry.py",
                "src/modelome/sources/paddlenlp_t5_registry.py",
                "src/modelome/sources/paddlenlp_unimo_registry.py",
        ...
        "nnU-Net": {
            "src/modelome/sources/nnunet_registry.py",
            "src/modelome/sources/nnunet_zenodo_bundles.py",
        },
        "RFdiffusion": {
            "src/modelome/sources/catalog.py",
