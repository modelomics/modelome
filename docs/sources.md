...
for all neural-model entities. The current default configuration has **336 enabled
source entries** (321 loadable without provider credentials; a count of `config/sources.toml`,
