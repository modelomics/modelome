...
The default catalog contains **487 enabled sources** (462 loadable without provider
...
The default catalog currently has **487 enabled sources** (462 loadable without provider credentials); this is a configuration count,
